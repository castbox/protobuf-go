...
func NewGenerator(plugin *newgen.Plugin, featureNames []string, cfg *Config) (*Generator, error) {
...
func (gen *Generator) Generate() {
	for _, file := range gen.plugin.Files {
		...
		gf := gen.plugin.NewGeneratedFile(file.GeneratedFilenamePrefix+"_guru.pb.go", importPath)
...
func (gen *Generator) generateFile(gf *protogen.GeneratedFile, file *protogen.File) {
	...
	p.P("// Code generated by protoc-gen-go-guru. DO NOT EDIT.")
	//if bi, ok := debug.ReadBuildInfo(); ok {
	p.P(fmt.Sprintf("// - protoc-gen-go-guru %s", release))
